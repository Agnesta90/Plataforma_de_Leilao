                        ...
                        <>
                            <article className="text-white tablet:rounded-2xl  bg-[#3d0f78]  shadow-[4px_4px_0px_#000] p-3.5 flex flex-col ">
                                <div className="flex justify-center gap-1.5">
                                    <section className="w-10 tablet:mx-auto"><img  src="./img/martelo3.png" alt="" className="w-full"/></section>
                                ...
                                <form>
                                    <div className="flex gap-1.5 tablet:block">
                                        <section className="w-[50%] tablet:w-full">
                                            ...
                                            <aside className={`pl-1.5 border-2 rounded-2xl p-1.5 flex items-center overflow-hidden mb-5 ${tipoOferta === "valor" ? "border-[#8B5BEE] bg-[#250F71]" : "border-gray-500 bg-gray-700 opacity-50"}`} >
                                                ...
                                                <input type="text" placeholder="00,00" disabled={tipoOferta !== "valor"} className="w-full h-full bg-transparent px-4 text-[#C7A6FF] outline-none placeholder:text-[#B88EFF]" />
                                            </aside>
                                        </section>
                                        <section className="w-[50%] tablet:w-full" >
                                            <label className="flex items-center gap-2 mb-1">
                                    ...
                                    <section className="w-full flex justify-around">
                                        <ButtonPadrao className='w-[40%]' type="submit" onclick={() => {setOferta(false);ProdutoSelecionado();}}> Finalizar </ButtonPadrao>
