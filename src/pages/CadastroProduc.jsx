...
export default function Cadastro(){
    ...
    return (
        <>
            ...
            <div className="p-4 bg-[#1E1C2F] tablet:bg-white overflow-hidden w-screen h-screen text-white tablet:text-black  ">
                
                <form onSubmit={handleSubmit(onSubmit)} className='tablet:w-200 tablet:h-135 tablet:m-auto tablet:grid grid-cols-[400px_1fr_120px_100px] tablet:mt-6  grid-rows-[repeat(6,90px)] flex flex-col gap-3.5 tablet:'>
                    <div className="w-15 block tablet:hidden" onClick={() => navigate('/')}>
                        <img className="w-full" src="./img/logo.png" alt="Logo" />
                    </div>
                    <div className='col-start-1 row-[1/2] order-2 '>
                    ...
                    <div className='col-start-1 row-[2/3] order-2' >
                    ...
                    <div className="col-[1/2] row-[3/4] order-2 ">
                        ...
                        <select className=" w-full tablet:w-62.5 border rounded-[5px] p-1 text-[16px] shadow-[4px_4px_0px_#fff] tablet:shadow-[4px_4px_0px_#000]  outline-0 mb-0.5 bg-[#3E0866] " aria-placeholder="Selecione uma categoria" {...register('categorie', {required: true})} defaultValue={''} >
                    ...
                    <div className='shadow-[4px_4px_0px_#fff] tablet:shadow-[4px_4px_0px_#000] w-30 h-30 tablet:w-100 tablet:h-90 row-[1/5] col-[2/5] ml-auto mr-auto tablet:ml-auto border-2 order-1 '>
                    ...
                    <div className="order-4 flex gap-3.5 ml-auto">
